<aside class="w-64 bg-[#EAC696] min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7 fixed">

    <!-- menu items -->
    <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
        
        <div class="font-bold text-center text-lg uppercase tracking-wider text-[#65451F] pb-2">Admin Home</div>

        {{-- <div class="font-medium pl-4 text-[#65451F] text-xs text-[11px] uppercase">Menu</div> --}}

        
        <a href="#">
            <div class="w-full flex items-center gap-x-1.5 group select-none text-[#65451F]">
                <div class="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-[102%] translate-y-full group-hover:translate-y-0 bg-[#65451F] transition-all duration-300"></div>
                </div>
                <div class="group-hover:bg-[#C8AE7D] w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="#">
                    <svg class="h-5 w-5 !fill-[#65451F] group-hover:fill-red-600 dark:fill-gray-600  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a href="#">
            <div class="w-full flex items-center gap-x-1.5 group select-none text-[#65451F]">
                ...
                <div class="group-hover:bg-[#C8AE7D] w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="#">
                    <svg class="h-5 w-5 group-hover:fill-[#65451F] fill-[#65451F] dark:fill-gray-600 transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a href="#">
            <div class="w-full flex items-center gap-x-1.5 group select-none text-[#65451F]">
                ...
                <div class="group-hover:bg-[#C8AE7D] w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm" href="#">
                    <svg class="h-5 w-5 group-hover:fill-[#65451F] fill-[#65451F]  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
